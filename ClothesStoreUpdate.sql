...
INSERT INTO `customer` VALUES (1,'Tran','Quang','000000','43 TQDBinh ThuyCan Tho',_binary ''),(2,'Phuoc','Vu Hoang','12345','123',_binary ''),(3,'Quang','Tran','12345','123',_binary ''),(5,'Hoang','Ha','12345','123',_binary ''),(6,'Vinh','Vo','12345','123',_binary ''),(7,'Minh','Tran','12345','123',_binary ''),(8,'Phuong','Vu','12345','123',_binary ''),(9,'Trinh','Vo','12345','123',_binary ''),(10,'Vy','Le','12345','123',_binary ''),(11,'Dung','Tran','12345','123',_binary '');
...
INSERT INTO `customeraccount` VALUES (1,'123@gmail.com','123',50.00,1),(2,'phuocchan@gmail.com','123',40.00,0),(3,'phuocchan2@gmail.com','123',135.00,1),(5,'qwwwfk@gmail.com','885243',0.00,0),(6,'rhctqz@gmail.com','287168',0.00,0),(7,'pfwges@gmail.com','683439',0.00,0),(8,'ndnzmx@gmail.com','76177',0.00,0),(9,'vtnqbq@gmail.com','629891',0.00,0),(10,'ibqsmi@gmail.com','993551',0.00,0),(11,'ywylvd@gmail.com','242696',0.00,0);
...
INSERT INTO `levels` VALUES (0,0.00,0.00),(1,0.05,50.00),(2,0.10,150.00),(3,0.15,300.00);
...
INSERT INTO `order_products` VALUES (39,3,25.00,2,50.00,1,2),(40,2,27.00,2,54.00,2,1),(40,3,25.00,4,100.00,1,2),(41,2,27.00,1,27.00,1,3);
...
INSERT INTO `orders` VALUES (39,1,48,'2023-11-24 19:08:11',0,0.05,0,NULL,0),(40,1,146,'2023-11-25 07:45:41',0,0.05,0,NULL,0),(41,1,26,'2023-11-25 08:14:11',0,0.05,0,NULL,0);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `TRIGG_UpdateCompleteDate` BEFORE UPDATE ON `orders` FOR EACH ROW BEGIN
    ...
    -- elseif new.isConfirmed = 2 and new.status = 2 and new.isCancel != true then
    elseif new.isConfirmed = 2 and new.isCancel != true then
...
INSERT INTO `products` VALUES (1,'T-shirt',20,11,3,1,NULL,NULL),(2,'Women\'s shirt',27,6,3,1,NULL,NULL),(3,'Men Cargo shirt',25,90,3,1,NULL,NULL),(4,'Cargo Pants 1',40,19,2,2,NULL,NULL),(5,'Cargo Pants 2',38,15,2,2,NULL,NULL),(6,'Cargo Pants 3',45,21,2,2,NULL,NULL);
...
-- Dump completed on 2023-11-25 12:23:41
